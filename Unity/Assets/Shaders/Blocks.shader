...
////// Emissive:
                float node_4524 = 0.0;
                float3 emissive = lerp(float3(node_4524,node_4524,node_4524),node_8546,(saturate((abs(i.posWorld.g)/_MaxHeight))*_EmitStrength));
/// Final Color:
