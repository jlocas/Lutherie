...
////// Specular:
                ...
                float3 indirectSpecular = (0 + _Cubemap_var.rgb)*specularColor;
...
/////// Diffuse:
                ...
                indirectDiffuse += _Cubemap_var.rgb; // Diffuse Ambient Light
